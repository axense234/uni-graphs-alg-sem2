...
public:
    ...
    /**
     * @brief Topologically sorts the vertices in the graph and returns a copy of said sorted. It uses the predecessor counting algorithm, where the main idea is to keep removing vertices without predecessors and keeping track of the vertices still in the graph.
     *
     * @param graph given graph
     * @return sorted: std::pair<bool, std::vector<Vertex>>, empty sorted if
     */
    static std::pair<bool, std::vector<Vertex>> topologicalSort(ADTDirectedGraph graph);
};